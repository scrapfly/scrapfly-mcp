...
type ScreenshotToolInput struct {
	...
	VisionDeficiencyType scrapfly.VisionDeficiencyType `json:"vision_deficiency_type,omitempty" jsonschema:"The vision deficiency to use for the screenshot."`
}
...
func ScreenshotConfigFromScreenshotToolInput(input ScreenshotToolInput) (*scrapfly.ScreenshotConfig, error) {
	config := &scrapfly.ScreenshotConfig{
		...
		VisionDeficiencyType: input.VisionDeficiencyType,
	}
